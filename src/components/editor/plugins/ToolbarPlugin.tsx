...
import { AlignCenter, AlignJustify, AlignLeft, AlignRight, Bold, Heading1, Heading2, Heading3, Italic, Redo, Strikethrough, Underline, Undo } from 'lucide-react';
...
export default function ToolbarPlugin() {
  ...
  return (
    <div className="toolbar bg-gray-950"  ref={toolbarRef}>
      <button
        disabled={!canUndo}
        onClick={() => {
